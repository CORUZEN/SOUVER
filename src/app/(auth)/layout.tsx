...
export default function AuthLayout({
  ...
  return (
    <div className={cn(manrope.className, 'relative h-dvh overflow-hidden bg-[#08142a]')}>
      <div className="pointer-events-none absolute left-[-20%] top-[-20%] h-[36rem] w-[36rem] rounded-full bg-emerald-400/[0.15] blur-[120px]" />
      <div className="pointer-events-none absolute bottom-[-26%] right-[-12%] h-[30rem] w-[30rem] rounded-full bg-cyan-400/[0.10] blur-[110px]" />

      <div className="relative z-10 h-full overflow-y-auto overscroll-contain px-3 py-3 sm:px-5 sm:py-5 lg:px-8 lg:py-6">
        <div className="mx-auto flex min-h-full w-full max-w-[1440px] items-center">
          <div className="grid w-full overflow-hidden rounded-[28px] border border-white/[0.2] bg-white/[0.06] shadow-[0_24px_70px_rgba(2,8,23,0.45)] backdrop-blur-md lg:grid-cols-[1.08fr_0.92fr]">
            <section className="order-2 relative min-h-[360px] overflow-hidden lg:order-1">
              <div
              ...
              <div className="relative z-10 flex h-full flex-col justify-between p-7 text-white sm:p-10 lg:p-10 xl:p-12">
                <div className="animate-[authFadeUp_650ms_ease-out]">
                  <div className="mb-5 inline-flex items-center gap-3 rounded-full border border-white/[0.3] bg-white/[0.12] px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-white/[0.9] backdrop-blur-xl">
                    Sistema Ouro Verde
                  </div>
                  ...
                  <p className="mt-4 max-w-xl text-sm leading-relaxed text-white/[0.82] sm:text-base">
                ...
                <div className="mt-7 grid gap-3 sm:grid-cols-2 lg:mt-8 lg:grid-cols-1">
                  <article className="animate-[authFadeUp_760ms_ease-out] rounded-2xl border border-white/[0.3] bg-white/[0.12] p-4 backdrop-blur-xl [animation-fill-mode:both]">
                    <div className="mb-2 inline-flex rounded-lg bg-white/[0.2] p-2">
                      <ShieldCheck className="h-4 w-4 text-emerald-100" />
                    </div>
                    <p className="text-sm font-semibold text-white">Conformidade e segurança</p>
                    <p className="mt-1 text-xs text-white/[0.75]">
                      Controle de acesso, trilhas de auditoria e proteção para dados sensíveis.
                    </p>
                  </article>

                  <article className="animate-[authFadeUp_900ms_ease-out] rounded-2xl border border-white/[0.3] bg-white/[0.12] p-4 backdrop-blur-xl [animation-fill-mode:both]">
                    <div className="mb-2 inline-flex rounded-lg bg-white/[0.2] p-2">
                  ...
                  <article className="animate-[authFadeUp_1040ms_ease-out] rounded-2xl border border-white/[0.3] bg-white/[0.12] p-4 backdrop-blur-xl [animation-fill-mode:both] sm:col-span-2 lg:col-span-1">
                    <div className="mb-2 inline-flex rounded-lg bg-white/[0.2] p-2">
            ...
            <section className="order-1 relative flex items-center justify-center bg-white/[0.92] px-6 py-8 sm:px-10 sm:py-10 lg:order-2 lg:px-10 lg:py-10 xl:px-12">
