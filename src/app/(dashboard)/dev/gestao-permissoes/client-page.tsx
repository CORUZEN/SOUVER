...
const MODULE_PERMISSION_ITEMS: ModulePermissionItem[] = [
  ...
  { viewCode: 'module_previsao:view', interactCode: 'module_previsao:interact', label: 'Previsão de Pedidos', description: 'Submenu de Logística — Previsão de pedidos em aberto.' },
  ...
  { viewCode: 'module_usuarios:view', interactCode: 'module_usuarios:interact', label: 'Usuários', description: 'Submenu de RH — Gestão de usuários e permissões.' },
  ...
  { viewCode: 'module_analytics:view', interactCode: 'module_analytics:interact', label: 'Analytics', description: 'Análise corporativa e indicadores.' },
  { viewCode: 'module_auditoria:view', interactCode: 'module_auditoria:interact', label: 'Auditoria', description: 'Trilhas de auditoria e compliance.' },
