 ...
 * Sobrepõe a tela inteira com position:fixed apenas em telas < md.
 * Em tablet/desktop (md+) fica oculta e o layout web padrão é exibido.
 */
export default function MobileLoginDark() {
  ...
  return (
    <div className="mobile-login-overlay pwa-theme fixed inset-0 z-50 flex flex-col md:hidden">
      {/* ── Header — logos ──────────────────────────────────────── */}
      ...
      {/* ── Form card ───────────────────────────────────────────── */}
      <div className="mx-4 flex flex-1 flex-col overflow-y-auto">
