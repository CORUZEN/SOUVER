      ...
      <div className="relative w-[86%] max-w-sm">
        <div className="mx-auto mb-6 h-24 w-24">
          <div className="relative h-full w-full">
            <Image src="/branding/ouroverde.png" alt="Ouro Verde" fill sizes="96px" className="object-contain" />
          </div>
        </div>

        <p className="text-center text-base font-semibold tracking-[0.03em] text-emerald-100">OURO VERDE</p>
